...
@section('content')
    <section class="h-screen">
        <div class="container mx-auto px-6 py-12 h-full flex flex-col items-center justify-center">
            ...
            <div>
                <span class="text-green-600 text-left">You have been succcessfully registered. Plaease, log in.</span>
            </div>
            @endif
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div class="form-group form-check">
                            <input
                                ...
                                checked
                            />
                            <label class="form-check-label inline-block text-gray-800" for="rememberme"
                            >Remember me</label
                            >
                        </div>
                        <a
